export default class DrawCanvas {
  ...
  runCircle() {
    ...
    this.option = Object.extend(defaultSetting, this.settings);
    ...
    this.canvasC = document.getElementById(obj);  //this.$refs.canvasDom    this.option.obj


    console.log("this.canvasC",this.canvasC)
    /*控制运动*/
