...
<div>
   ...
   <table class="socreTable" border="0" align="center" v-if="tableFixedShow">
     <thead style="cursor: pointer;" class="tableFixed">
      <tr style="background-color: #fff;">
        <td @click="sort = {key: 'index', val: -sort.val}">排名&nbsp;
          <i class="arrIcon">
            <img src="../../assets/img/arrRank.png">
...
methods:{
  ...
  watchStu(ind){
    window.sessionStorage.setItem('index',this.index * 1)
